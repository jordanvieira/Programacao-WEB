...
<body>
    ...
    <figure class="centro-distribuicao figure">
        <img src="img/centro-distribuicao.png">
        <figcaption class="figcaption">Centro de distribuição da Mirror
            Fashion</figcaption>
    </figure>

    <p>Compre suas roupas e acessórios na Mirror Fashion. Acesse <a href="index.html">nossa loja</a> ou entre em contato
        se tiver dúvidas. Conheça também <a href="#historia">nossa história</a> e <a href="#diferencias">nossos
            diferenciais.</a></p>



    <h2 class="titulo2" id="historia">História</h2>
    <figure class="familia-pelho figure">
        <img src="img/familia-pelho.jpg">
        <figcaption class="figcaption">Família Pelho</figcaption>
    </figure>
    ...
    <h2 class="titulo2" id="diferencias">Diferenciais</h2>
    <ul class="lista">
